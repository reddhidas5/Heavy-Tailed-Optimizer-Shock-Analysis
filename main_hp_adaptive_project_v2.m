function main_hp_adaptive_project_v2()
% MAIN_HP_ADAPTIVE_PROJECT_V2
...
% -------------------------------------------------------------------------
    ...
    config.data_filename  = 'hp_adaptive_v2_results.mat';
    config.save_figures   = true;
    config.figure_prefix  = 'hp_adaptive_v2_';
    ...
    if config.save_data
        save(config.data_filename, ...
            'config','problem','results','stats','tuned','impulse','-v7.3');
...
function plot_impulse_response(config,impulse)
    ...
    xline(config.impulse_time,'--','Impulse');
    xlabel('Iteration k');
    ylabel('||\Delta x_k||_2');
...
function export_summary_tables(config,stats)
    ...
    writetable(Tsummary,'hp_adaptive_v2_summary.csv');
    ...
    writetable(Tviol,'hp_adaptive_v2_violation_summary.csv');

    fprintf('Exported:\n');
    fprintf('  hp_adaptive_v2_summary.csv\n');
    fprintf('  hp_adaptive_v2_violation_summary.csv\n');
end
